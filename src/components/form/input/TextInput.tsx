  ...
  return (
    <div className="relative">
      <input
        ...
        onFocus={handleFocus}
        onBlur={handleBlur}
        className="block w-full px-4 py-2 border border-gray-300 dark:border-slate-600 dark:bg-slate-800 dark:text-white rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
      />
      <label
